 ...
 *
 * @zenClass mods.gregtech.recipe.functions.ICheckRecipeFunction
 */
@FunctionalInterface
@ZenClass("mods.gregtech.multiblock.functions.ICheckRecipeFunction")
@ZenRegister
public interface ICheckRecipeFunction {
