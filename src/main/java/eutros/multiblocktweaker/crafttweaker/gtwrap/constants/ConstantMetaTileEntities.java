...
@ZenRegister
public class ConstantMetaTileEntities implements IBracketHandler {
    ...
    public ConstantMetaTileEntities() {
        this.method = CraftTweakerAPI.getJavaMethod(ConstantMetaTileEntities.class, "get", String.class);
    ...
    public IZenSymbol resolve(IEnvironmentGlobal environment, List<Token> tokens) {
        ...
        if (!tokens.get(0).getValue().equalsIgnoreCase("metaTileEntities")) return null;
