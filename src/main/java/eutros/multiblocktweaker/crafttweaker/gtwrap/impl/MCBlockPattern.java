...
public class MCBlockPattern implements IBlockPattern {
    ...
    public @NotNull MCPatternMatchContext checkPatternAt(IWorld world, IBlockPos centerPos, IFacing facing) {
        return new MCPatternMatchContext(internal.checkPatternAt(CraftTweakerMC.getWorld(world), CraftTweakerMC.getBlockPos(centerPos), (EnumFacing) facing.getInternal()));
    }
